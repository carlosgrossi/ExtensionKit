...
public extension URLSession {
	...
	*/
	public static func dataTask(with url: URL?, requestMethod: String? = nil, requestValues: [String: String]? = nil, completitionHandler:@escaping (Data?, URLResponse?, Error?) -> Void) {
	...
	*/
	public static func validateURLSessionDataTask(_ data: Data?, response: URLResponse?, error: NSError?, completitionHandler:(_ data: Data, _ error: Error?) -> Void) {
		if error == nil {
