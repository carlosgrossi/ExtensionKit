#
#  Be sure to run `pod spec lint ExtensionKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Carlos Grossi"
  # s.authors            = { "Carlos Grossi" => "carlos.grossi@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Carlos Grossi"
